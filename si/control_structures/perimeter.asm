...
prompt2 db "Entere a positive floating point number: ", 10 , 0 
...
mov r15, 0              ;boolean for if negative
mov r14, 0            ;a zero to check against user input
;zeroes out an xmm register 
xorpd xmm13, xmm13     
loop:
    push qword 0 
    mov rdi, prompt2
    ...
    ;validate- if less than zero== true, else false 
    ;xorpd xmm13, xmm13      ;zeroes out an xmm register 
     ucomisd xmm14, xmm13      ;floating point nums comparison 

    ;if less than zero jump bacvk to beginnign 
    jb loop
