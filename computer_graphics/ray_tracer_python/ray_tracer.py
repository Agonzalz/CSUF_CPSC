...
def ray_trace(file, camera, width=300, height=200):
  max_depth = 3
...
def main(file):
    ...
    # camera = np.array([0, 0, 0.35])
    camera = Spheres.get_camera()
    ray_trace(file=file, camera=camera, height=400)
