...
>
test adjoint
<'a_MinorsTranspose', <col0,   2   2   0   0><col1,  -2   3  10   0><col2,   2  -3   0   0>> OR by rows...
  2  -2   2 
  2   3  -3 
 -0  10   0 
>
<'b_MinorsTranspose', <col0, -24  18   5   0><col1,  20 -15  -4   0><col2,  -5   4   1   0>> OR by rows...
-24  20  -5 
 18 -15   4 
  5  -4   1 
>
test inverse
<'0.100000*a_MinorsTranspose', <col0*0.100000, 0.2 0.2   0   0><col1*0.100000, -0.2 0.3   1   0><col2*0.100000, 0.2 -0.3   0   0>> OR by rows...
0.2 -0.2 0.2 
0.2 0.3 -0.3 
 -0   1   0 
>
<'1.000000*b_MinorsTranspose', <col0*1.000000, -24  18   5   0><col1*1.000000,  20 -15  -4   0><col2*1.000000,  -5   4   1   0>> OR by rows...
-24  20  -5 
 18 -15   4 
  5  -4   1 
>
test a * ainv, b * binv
<'a*0.100000*a_MinorsTranspose', <col0,   1   0   0   0><col1,   0   1   0   0><col2,   0   0   1   0>> OR by rows...
  1   0   0 
  0   1   0 
  0   0   1 
>
<'b*1.000000*b_MinorsTranspose', <col0,   1   0   0   0><col1,   0   1   0   0><col2,   0   0   1   0>> OR by rows...
  1   0   0 
  0   1   0 
  0   0   1 
>
